...
public class DocWordCount extends Configured implements Tool {
 ...
 // the map splits the input file at spaces and writes the output as word#####filename	1.
      ...
      public void map( LongWritable offset,  Text lineText,  Context context)
        throws  IOException,  InterruptedException {
         ...
         for ( String word  : WORD_BOUNDARY .split(line)) {
           ...
           Text currentWord = new Text(word+"#####"+file);       
           context.write(currentWord, one);
         }
      }
   }
//the reducer jobs gets the output from tht mapper and counts the total occurences of each word and writes the output as word#####filename	wordcount.
